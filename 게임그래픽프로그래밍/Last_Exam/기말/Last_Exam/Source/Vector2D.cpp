...
#pragma region ____Vector2D____
...
#pragma region ___Vertex2D___
Point Vertex2D::getPos()
{
	return vector.getPos();
}
void Vertex2D::setPos(Point _point)
{
	vector.setPos(_point);
}
void Vertex2D::setPos(float _x, float _y)
{
	vector.setPos(_x, _y);
}
#pragma endregion
